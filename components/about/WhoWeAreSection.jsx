...
const WhoWeAreSection = () => {
  return (
    <div className="w-[90%] m-auto px-5 text-center mt-10 md:mt-25 flex flex-col md:flex-row gap-10">
      <div className='hidden w-[40%] md:flex justify-center'>
        <Image src={about_image} alt='image'/>
      </div>
      <div className='md:w-[60%] w-full'>
     <p className="text-center md:text-start mb-10 heading">
      ...
      <div className="flex flex-col gap-10">
        ...
        <p className="text-justify md:text-start para">
