  ...
  const steps = [
    {
      ...
      content: (
        ...
        <div className="flex flex-col gap-4 mb-4">
          <label htmlFor="Name" className="">Phone No.</label>
          <input
            type="text"
            name="Phone No."
    ...
    },
    {
      ...
      content: (
        <>
          <div className="flex flex-col gap-4 mb-4">
          <label htmlFor="Name" className="">Preferred wedding Date</label>
          <input
            type="date"
            name="date"
            placeholder=""
         ...
         <div className="flex flex-col gap-4 mb-4">
          <label htmlFor="Name" className="">No. of guests</label>
          <input
            type="text"
            name="Phone No."
            placeholder="Phone No."
        ...
        <div className="flex flex-col gap-4 mb-4">
          <label htmlFor="Name" className="">Name of the city</label>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 mb-5">
      ...
      <div className="md:hidden max-w-md w-full mt-10 bg-white shadow-[0px_4px_31.8px_rgba(0,0,0,0.18)] rounded-[22px] p-6">
        {step > 0 && (
            <Image src={backicon} alt="Back" className="cursor-pointer mb-4" onClick={() => setStep(step - 1)} />
          )}
