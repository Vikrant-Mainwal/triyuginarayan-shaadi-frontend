...
const ExperienceSection = () => {
  return (
    <div className="w-[90%] m-auto p-10 mt-5 flex flex-col gap-10 text-center">
      ...
      <div className="flex flex-col gap-10 p-10 m-auto">
        <div className="flex gap-4 justify-center flex-wrap">
          <div className="flex flex-col gap-2 justify-center items-center w-full max-w-[300px]">
            <Image src={Pheras} alt="Pheras image" className="w-[150px] rounded-lg" />
            <p className="text-[16px] md:text-[18px]">
              Pheras around the same fire where Shiva-Parvati got married
            </p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center w-[300px]">
            <Image src={Havan} alt="Havan image" className="w-[150px]" />
            <p className="text-[16px] md:text-[18px]">
              Havan (sacred fire ceremony) with holy chants
            </p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center w-[300px]">
            <Image src={Geet} alt="Geet image" className="w-[150px]" />
            <p className="text-[16px] md:text-[18px]">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <div className="flex flex-col gap-2 justify-center items-center w-[300px]">
            <Image src={Dhol} alt="Dhol image" className="w-[150px]" />
            <p className="text-[16px] md:text-[18px]">
              Dhol–Damau music to celebrate your love
            </p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center w-[300px]">
            <Image src={Jaimala} alt="Jaimala image" className="w-[150px]" />
            <p className="text-[16px] md:text-[18px]">
