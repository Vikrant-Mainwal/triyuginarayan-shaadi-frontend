    ...
    <div className="bg-[#FFE4B8]">
      <div className="max-w-[1400px] w-full mx-auto p-10 text-[#000] flex flex-col gap-[50px]">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 items-start">
          ...
          <div className="md:w-1/2 flex flex-col gap-2 md:items-end text-center md:text-start">
            <h2>Contact Us</h2>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 items-center md:items-end">
          ...
          <div className="md:w-1/2 flex flex-col items-center md:items-end text-center md:text-right gap-3">
            <h2>Follow us</h2>
